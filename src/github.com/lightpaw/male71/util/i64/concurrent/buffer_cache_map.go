...
func newVersionBufferCacheMap(f func(int64, uint64) (pbutil.Buffer, error), curTime func() time.Time, expireAfter time.Duration) *BufferCacheWithExpireTimeMap {
...
func (m *BufferCacheWithExpireTimeMap) GetBuffer(key int64) (pbutil.Buffer, error) {
	_, msg, err := m.GetVersionBuffer(key)
	return msg, err
}

func (m *BufferCacheWithExpireTimeMap) GetVersionBuffer(key int64) (uint64, pbutil.Buffer, error) {
...
func (m *BufferCacheWithExpireTimeMap) GetI32VersionBuffer(key int64) (int32, pbutil.Buffer, error) {
	version, msg, err := m.GetVersionBuffer(key)
	return concurrent.I32Version(version), msg, err
}

func (m *BufferCacheWithExpireTimeMap) Clear(key int64) {
...
func (m *BufferCacheWithExpireTimeMap) createAndSet(key int64, oldValue *buffer_cache_with_expire_time) *buffer_cache_with_expire_time {
...
func (m *BufferCacheWithExpireTimeMap) newFunc(key int64) func() (uint64, pbutil.Buffer, error) {
