...
//
//func New() *recovtimes.RecoverTimes {
//	return NewRecoverableTimes(time.Time{}, duration, maxTimes)
//}
//
//// 测试
//func TestNewRecoverableTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//	Ω(rt.StartTime()).Should(BeEquivalentTo(time.Time{}))
//	Ω(rt.RecoveryDuration()).Should(BeEquivalentTo(duration))
//	Ω(rt.MaxTimes()).Should(BeEquivalentTo(maxTimes))
//}
//
//func TestRecoverableTimes_SetStartRecoverTime(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_Times(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_floatTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_HasEnoughTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_ReduceOneTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_ReduceTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_GiveTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//}
//
//func TestRecoverableTimes_ChangeRecoveryDuration(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
...
//	Ω(rt.Times(ctime)).Should(BeEquivalentTo(3))
//
//	rt.ChangeRecoveryDuration(duration/2, ctime)
//	Ω(rt.Times(ctime)).Should(BeEquivalentTo(3))
//	Ω(rt.StartTime()).Should(BeEquivalentTo(ctime.Add(-duration * 3 / 2)))
//
//	// 变更回来
//	rt.ChangeRecoveryDuration(duration, ctime)
//	Ω(rt.Times(ctime)).Should(BeEquivalentTo(3))
...
//
//	rt.ChangeRecoveryDuration(duration/2, ctime.Add(duration))
//	Ω(rt.Times(ctime)).Should(BeEquivalentTo(0))
//	Ω(rt.Times(ctime.Add(duration))).Should(BeEquivalentTo(2))
//	Ω(rt.StartTime()).Should(BeEquivalentTo(ctime))
//}
//
//func TestRecoverableTimes_ChangeMaxTimes(t *testing.T) {
//	RegisterTestingT(t)
//
//	rt := New()
//
