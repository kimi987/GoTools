...
// source: github.com/lightpaw/male7/gen/pb/rank/rank.proto
// DO NOT EDIT!
...
/*
	...
	It is generated from these files:
		github.com/lightpaw/male7/gen/pb/rank/rank.proto
...
type C2SRequestRankProto struct {
	...
	StartCount   int32  `protobuf:"varint,4,opt,name=start_count,json=startCount,proto3" json:"start_count,omitempty"`
...
func (*C2SRequestRankProto) Descriptor() ([]byte, []int) { return fileDescriptorRank, []int{0} }

func (m *C2SRequestRankProto) GetRankType() int32 {
	if m != nil {
		return m.RankType
	}
	return 0
...
func (m *C2SRequestRankProto) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *C2SRequestRankProto) GetStartCount() int32 {
	if m != nil {
		return m.StartCount
	}
	return 0
...
func (m *C2SRequestRankProto) GetJunXianLevel() int32 {
	if m != nil {
...
func (m *C2SRequestRankProto) GetSubType() int32 {
	if m != nil {
		return m.SubType
	}
	return 0
...
type S2CRequestRankProto struct {
	Rank []byte `protobuf:"bytes,1,opt,name=rank,proto3" json:"rank,omitempty"`
}
...
func (*S2CRequestRankProto) Descriptor() ([]byte, []int) { return fileDescriptorRank, []int{1} }

func (m *S2CRequestRankProto) GetRank() []byte {
	if m != nil {
		return m.Rank
	}
	return nil
...
func (m *C2SRequestRankProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartCount != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintRank(dAtA, i, uint64(m.StartCount))
	}
	if m.JunXianLevel != 0 {
		dAtA[i] = 0x28
		i++
...
func (m *S2CRequestRankProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Rank) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRank(dAtA, i, uint64(len(m.Rank)))
...
func (m *C2SRequestRankProto) Size() (n int) {
	...
	if m.StartCount != 0 {
		n += 1 + sovRank(uint64(m.StartCount))
	}
	if m.JunXianLevel != 0 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartCount |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *S2CRequestRankProto) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Rank = append(m.Rank[:0], dAtA[iNdEx:postIndex]...)
			if m.Rank == nil {
				m.Rank = []byte{}
			}
			iNdEx = postIndex
...
func init() {
	proto.RegisterFile("github.com/lightpaw/male7/gen/pb/rank/rank.proto", fileDescriptorRank)
}

var fileDescriptorRank = []byte{
	// 275 bytes of a gzipped FileDescriptorProto
	,
}
